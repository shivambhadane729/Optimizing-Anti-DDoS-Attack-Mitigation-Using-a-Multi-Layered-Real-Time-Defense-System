"""Add new fields to AttackLog model

Revision ID: 3cff33ad2ab6
Revises: 
Create Date: 2025-06-13 16:23:48.481532+00:00
...
def upgrade() -> None:
    ...
    op.add_column('alerts', sa.Column('timestamp', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False))
    op.add_column('alerts', sa.Column('message', sa.String(), nullable=False))
